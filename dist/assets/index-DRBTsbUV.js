...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function If(i,t,e){const n=new Float32Array(ni),s=new L(0,1,0);return new xn({name:"SphericalGaussianBlur",defines:{n:ni,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:rr(),fragmentShader:`
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function Jo(){return new xn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:rr(),fragmentShader:`
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function Qo(){return new xn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:rr(),fragmentShader:`
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function rr(){return`
...
#define LOW_PRECISION`),t}const Zp={[Gs]:"SHADOWMAP_TYPE_PCF",[es]:"SHADOWMAP_TYPE_VSM"};function Kp(i){return Zp[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const $p={[ri]:"ENVMAP_TYPE_CUBE",[Oi]:"ENVMAP_TYPE_CUBE",[ir]:"ENVMAP_TYPE_CUBE_UV"};function Jp(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":$p[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Qp={[Oi]:"ENVMAP_MODE_REFRACTION"};function tm(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Qp[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const em={[Sl]:"ENVMAP_BLENDING_MULTIPLY",[Nc]:"ENVMAP_BLENDING_MIX",[Fc]:"ENVMAP_BLENDING_ADD"};function nm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":em[i.combine]||"ENVMAP_BLENDING_NONE"}function im(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function sm(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Kp(e),c=Jp(e),u=tm(e),d=nm(e),f=im(e),m=Gp(e),g=Hp(r),v=s.createProgram();let p,h,y=e.glslVersion?"#version "+e.glslVersion+`
